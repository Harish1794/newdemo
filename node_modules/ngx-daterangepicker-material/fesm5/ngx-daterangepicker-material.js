...
var /** @type {?} */ LOCALE_CONFIG = new InjectionToken('daterangepicker.config');
/**
 *  DefaultLocaleConfig
 */
var /** @type {?} */ DefaultLocaleConfig = {
    direction: 'ltr',
    separator: ' - ',
    weekLabel: 'W',
    applyLabel: 'Apply',
...
var DaterangepickerComponent = /** @class */ (function () {
    ...
    function (side) {
        ...
        var /** @type {?} */ daysInMonth = moment$1([year, month]).daysInMonth();
        var /** @type {?} */ firstDay = moment$1([year, month, 1]);
        var /** @type {?} */ lastDay = moment$1([year, month, daysInMonth]);
        var /** @type {?} */ lastMonth = moment$1(firstDay).subtract(1, 'month').month();
        var /** @type {?} */ lastYear = moment$1(firstDay).subtract(1, 'month').year();
        var /** @type {?} */ daysInLastMonth = moment$1([lastYear, lastMonth]).daysInMonth();
        ...
        var /** @type {?} */ curDate = moment$1([lastYear, lastMonth, startDay, 12, minute, second]);
        for (var /** @type {?} */ i = 0, /** @type {?} */ col = 0, /** @type {?} */ row = 0; i < 42; i++, col++, curDate = moment$1(curDate).add(24, 'hour')) {
            if (i > 0 && col % 7 === 0) {
                col = 0;
                row++;
            }
