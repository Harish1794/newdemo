...
import { InjectionToken, Injectable, Inject, Component, ElementRef, ViewChild, EventEmitter, Output, Input, forwardRef, ViewEncapsulation, ChangeDetectorRef, Directive, ViewContainerRef, ComponentFactoryResolver, HostListener, KeyValueDiffers, Renderer2, NgModule } from '@angular/core';
...
const /** @type {?} */ LOCALE_CONFIG = new InjectionToken('daterangepicker.config');
/**
 *  DefaultLocaleConfig
 */
const /** @type {?} */ DefaultLocaleConfig = {
    direction: 'ltr',
    separator: ' - ',
    weekLabel: 'W',
    applyLabel: 'Apply',
...
class DaterangepickerComponent {
    ...
    renderCalendar(side) {
        ...
        const /** @type {?} */ daysInMonth = moment$1([year, month]).daysInMonth();
        const /** @type {?} */ firstDay = moment$1([year, month, 1]);
        const /** @type {?} */ lastDay = moment$1([year, month, daysInMonth]);
        const /** @type {?} */ lastMonth = moment$1(firstDay).subtract(1, 'month').month();
        const /** @type {?} */ lastYear = moment$1(firstDay).subtract(1, 'month').year();
        const /** @type {?} */ daysInLastMonth = moment$1([lastYear, lastMonth]).daysInMonth();
        ...
        let /** @type {?} */ curDate = moment$1([lastYear, lastMonth, startDay, 12, minute, second]);
        for (let /** @type {?} */ i = 0, /** @type {?} */ col = 0, /** @type {?} */ row = 0; i < 42; i++, col++, curDate = moment$1(curDate).add(24, 'hour')) {
            if (i > 0 && col % 7 === 0) {
                col = 0;
                row++;
            }
...
export { NgxDaterangepickerMd, DaterangepickerComponent, DaterangepickerDirective, LOCALE_CONFIG, DefaultLocaleConfig, LocaleService };
